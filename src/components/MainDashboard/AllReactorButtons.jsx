    ...
    return (
        <>
            <Stack spacing={2} direction="row">
                ...
                <Button onClick={startReactors} variant="contained" size="small" sx={{ color: 'regularButton' }}>Start All Reactors</Button>
                <Button onClick={handleRefuel} variant="contained" size="small" sx={{ color: 'regularButton' }}>Refuel All Reactors</Button>
                <Button onClick={handleMaintenance} variant="contained" size="small" sx={{ color: 'regularButton' }}>All Reactor Maintenance</Button>
